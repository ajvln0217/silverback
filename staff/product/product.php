        ...
        <div class="col-md-12 py-md-5 mx-md-5">
          <div class="card1 shadow">
            <div class="card-header">
              ...
              <h4><i class="fa-solid fa-boxes-stacked"></i> Products <a class="bt float-end" href="./addprod.php"><i class="fa-regular fa-plus"></i> Add New Product</a></h4>
            </div>
            <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= $status == '0' ? "Trending" : "Visible" ?></td>
                      <td><?= max($qty, 0); ?></td>

                      <form action="../code.php" method="POST">
                        <input type="hidden" name="product_id" value="<?php echo $result['prod_id']; ?>">
                        <td><a href="./editprod.php?id=<?= $result['prod_id']; ?>" class="btn btn-primary">Edit</td>
                        <td>
                          <button type="submit" class="btn btn-danger delete_prod" name="delete_prod" value="<?= $result['prod_id']; ?>">Delete</button>
                      </form>
                      </td>
                    </tr>
                  <?php
