...
<head>
  ...
  <title>Silverback | Select Category </title>
</head>
    ...
    <div class="container">
      <div class="row">
        <div class="cold-md-12">
          ...
          ?>
          <p1 class="text-center"><span class="cat-text">Choose Category</span></p1><br><br>
          <hr style="width:100%">

          <div class="">
            <div class="row">
              <?php
              $category = getActive("category");
              if (mysqli_num_rows($category) > 0) {
                foreach ($category as $item) {
              ?>
                  <div class="col-md-3 container1 section">
                    <div class="card">
                      <div class="cont">
                      <a style="text-decoration: none;" href="../shop/shop.php?category=<?= $item['cat_index'] ?>">
                        <div class="card-body text-center img-bx">
                          <img src="../admin/images/<?= $item['cat_image'] ?>" alt="Category Image" class="w-100">
                        </div>
                        <div class="contbx text-center">
                          <br><br>
                        <h4 style="color:white;"><?= $item['cat_name']; ?></h4>
                        </div>
                      </div>
                      </a>
                    </div>
