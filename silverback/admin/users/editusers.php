        ...
        ?>
            <div class="card1 shadow">
              <div class="card-header">
                ...
                <h4><i class="fa-solid fa-user-pen"></i> Edit Users</h4>
              </div>
              <div class="card-body">
                <form action="../code.php" method="POST" enctype="multipart/form-data">
                  <input type="hidden" name="users_id" value="<?= $data['user_id']; ?>">
                  <div class="row">
                  </div>
                  <center>
                    <div class="mb-5 mt-2">
                      <div class="picture-container">
                        <div class="picture">
                          ...
                          <img src="../profile/<?= $data['image']; ?>" class="pic-src" id="pic-prev" />
                        </div>
                      </div>
                  ...
                  <div class="container">
                    <div class="row align-items-start mt-4">
                      <div class="col">
                        ...
                        <input required type="text" name="username" value="<?= $data['username']; ?>" placeholder="Enter First Name" class="form-control mb-2">
                        <label class="mb-0">Password</label>
                        <input required type="password" name="user_password" id="user_password" value="<?= $data['user_password']; ?>" placeholder="Enter Last Name" class="form-control mb-2">
                        <label class="mb-0">Confirm Password</label>
                        <input required type="password" name="cpassword" value="<?= $data['user_password']; ?>" placeholder="Enter email Address" class="form-control mb-2">
                        <label class="mb-0">email Address</label>
                        <input type="email" name="user_email" value="<?= $data['user_email']; ?>" placeholder="Enter email Address" class="form-control mb-2">
                      </div>

                      <div class="col">
                        <i class="fas fa-address-card fa-lg"></i> Basic Information <br><br>
                        <label class="mb-0">First Name</label>
                        <input required type="text" name="fname" value="<?= $data['fname']; ?>" placeholder="Enter First Name" class="form-control mb-2">
                        <label class="mb-0">Last Name</label>
                        <input required type="text" name="lname" value="<?= $data['lname']; ?>" placeholder="Enter Last Name" class="form-control mb-2">
                        <label class="mb-0">Contact Number</label>
                        <input type="number" name="contactnum" value="<?= $data['contactnum']; ?>" placeholder="Enter Contact Number" min=1 class="form-control mb-2">
                        <label class="mb-0">Birthday</label>
                        <input type="date" name="birthday" value="<?= $data['birthday']; ?>" placeholder="Enter Birthday" class="form-control mb-2">
                      </div>

                      <div class="col">
                        <i class="fas fa-city fa-lg"></i> Complete Address <br><br>
                        <label class="mb-0">Address</label>
                        <input required type="text" name="address" value="<?= $data['address']; ?>" placeholder="Enter Address" class="form-control mb-2">
                        <label class="mb-0">City</label>
                        <input required type="text" name="city" value="<?= $data['city']; ?>" placeholder="Enter City" class="form-control mb-2">
                        <label class="mb-0">Region</label>
                        <input required type="text" name="region" value="<?= $data['region']; ?>" placeholder="Enter Region" class="form-control mb-2">
                        <label class="mb-0">Zip</label>
                        <input type="number" name="zip" value="<?= $data['zip']; ?>" placeholder="Enter Zip Code" min=1 class="form-control mb-2">
                      </div>
                    </div>
                    <center>
                      <div class="row align-items-start mt-3">
                        <div class="col-sm-4 mt-2" style="margin-left: 45vh">
                          ...
                          <select name="user_role" class="form-select">
                            ...
                            $arr = mysqli_fetch_array($user_role);
                            $user_id = $_SESSION['auth_user']['user_id'];
                            if ($arr['user_id'] = $user_id) {
                              foreach ($user_role as $item => $dataa) {
                                if ($dataa['role'] > 1) {
                            ?>
                                  <option value="2" <?= $dataa['role'] == 2 ? "Selected" : "" ?>>Warehouse Admin</option>
                                  <option value="3" <?= $dataa['role'] == 3 ? "Selected" : "" ?>>Staff</option>
                            <?php
                                } else {
                                  echo "";
                                }
                  ...
                  <div class="col-md-12">
                    <button class="btn btn-primary" name="update_user">Save</button>
                  </div>
              </div>
            </div>
            </form>
