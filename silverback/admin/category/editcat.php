  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 py-md-5 mx-md-5">
        ...
        if (isset($_GET['id'])) {
          $cat_id = $_GET['id'];
          $category = getByID("category", $cat_id);
        ...
        ?>
            <div class="card1 shadow">
              <div class="card-header">
                ...
                <h4><i class="fa-solid fa-tag"></i> Edit Category</h4>
              </div>
              <div class="card-body">
                <form action="../code.php" method="POST" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="cat_index" value="<?= $data['cat_index']; ?>" placeholder="Enter Index Name" class="form-control">
                    </div>
                    <div class="col-md-12">
                      <label for="">Description</label>
                      <textarea rows="3" name="cat_description" placeholder="Enter Description" class="form-control"><?= $data['cat_description']; ?></textarea>
                    </div>
                    <div class="col-md-12">
                      <label for="">Upload Image</label>
                      <input type="file" name="cat_image" class="form-control">
                      <label for="">Current Image</label>
                      <input type="hidden" name="old_image" value="<?= $data['cat_image']; ?>">
                      <img src="../images/<?= $data['cat_image']; ?>" width="100px" height="100px">
                    </div>
                    <div class="col-md-12">
                      <label for="">Keywords</label>
                      <textarea row="3" name="cat_keywords" placeholder="Enter Keywords" class="form-control"><?= $data['cat_keywords']; ?></textarea>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="checkbox" <?= $data['cat_popular'] ? "checked" : "" ?> name="cat_popular">
                    </div>
                    <div class="col-md-12">
