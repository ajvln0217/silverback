        ...
        <div class="col-md-12 py-md-5 mx-md-5">
          <div class="card1 shadow">
            <div class="card-header">
              ...
              <h4><i class="fa-sharp fa-solid fa-users"></i> Manage Users <a class="bt float-end" href="./addusers.php"><i class="fa-solid fa-user-plus"></i> Add New User</a></h4>
            </div>
            <div class="card-body">
              <table id="users_table" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $query = mysqli_query($conn, "SELECT u.*,DATE_FORMAT(u.created_at, '%m-%d-%Y') AS created_date FROM `users` AS u WHERE u.role > '1' ORDER BY user_id;");
                  ...
                  ?>
                    <tr>
                      <td><?= $user_id; ?></td>
                      <td><?= $fname; ?> <?= $lname; ?></td>
                      <td><img src="../profile/<?php echo $image ?>" width="70px" height="70px" alt="<?php echo $image ?>" /></td>
                      <td><?php if ($role == 3) {
                            echo "Staff";
                          }
                          ?>
                      ...
                      <td><?= $lastactivity ?></td>
                      <td><a href="./editusers.php?id=<?= $result['user_id']; ?>" class="btn btn-primary">Edit</td>
                      <td>
                        <button type="button" class="btn btn-danger delete_user" value="<?= $result['user_id']; ?>">Delete</button>
                      </td>
                    </tr>
                  <?php
                  }
